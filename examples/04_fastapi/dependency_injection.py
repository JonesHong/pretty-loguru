...
configure_uvicorn()
# 創建主應用 logger
main_logger = create_logger("dependency_app", log_path="./logs")

# 創建不同服務的 logger 實例
auth_logger = create_logger("auth_service", log_path="./logs") 
user_logger = create_logger("user_service", log_path="./logs")
order_logger = create_logger("order_service", log_path="./logs")
